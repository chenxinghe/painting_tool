...
public class AppNodesBuilder {
    ...
    public CheckBox buildCheckBox(Object nodeId,
        ...
        public CheckBox buildCheckBox(Object nodeId,
            ...
            boolean enabled) {
        CheckBox checkBox = new CheckBox();
        initNode(nodeId.toString(), checkBox, parent, col, row, colSpan, rowSpan, styleClass, usesKeyHandler, focusTraversable, enabled);
    ...
    public ColorPicker buildColorPicker(Object nodeId,
            ...
            boolean enabled) {
        ColorPicker colorPicker = new ColorPicker();
        initNode(nodeId, colorPicker, parent, col, row, colSpan, rowSpan, styleClass, usesKeyHandler, focusTraversable, enabled);
        return colorPicker;
    }    
    ...
    public ComboBox buildComboBox(Object nodeId,
        ...
        // MAKE AND INIT THE COMBO BOX
        ComboBox comboBox = initComboBox(optionsListProperty, defaultValueProperty);
        initNode(nodeId, comboBox, parent, col, row, colSpan, rowSpan, styleClass, usesKeyHandler, focusTraversable, enabled);        
        return comboBox;
    }
    ...
    public GridPane buildGridPane(Object nodeId,
        ...
        initNode(nodeId, gridPane, parentPane, parentToolBar, styleClass, usesKeyHandler, focusTraversable, enabled);
        return gridPane;
    }
    ...
    public HBox buildHBox(Object nodeId,
            ...
            boolean enabled) {
        HBox box = new HBox();
        initNode(nodeId, box, parent, col, row, colSpan, rowSpan, styleClass, usesKeyHandler, focusTraversable, enabled);
        return box;
    }
    ...
    public Label buildLabel(Object nodeId,
        ...
        // MAKE AN INIT THE LABEL
        Label labelToBuild = new Label();
        initNode(nodeId, labelToBuild, parent, col, row, colSpan, rowSpan, styleClass, usesKeyHandler, focusTraversable, enabled);
    ...
    public Slider buildSlider(Object nodeId,
        ...
        initNode(nodeId, slider, parent, col, row, colSpan, rowSpan, styleClass, usesKeyHandler, focusTraversable, enabled);
    ...
    public Button buildTextButton(Object nodeId,
        ...
        // INITIALIZE THE OTHER SETTINGS
        initNode(nodeId, button, parent, col, row, colSpan, rowSpan, styleClass, usesKeyHandler, focusTraversable, enabled);
    ...
    public ToggleButton buildIconToggleButton(Object nodeId,
            ...
            boolean enabled) {
        // NOW MAKE THE TOGGLE BUTTON
        ToggleButton button = buildTextToggleButton(nodeId, parent, col, row, colSpan, rowSpan, styleClass, usesKeyHandler, focusTraversable, enabled);
    ...
    public void initNode(Object nodeId,
            Node node,
            Pane parentPane,
            ToolBar parentToolBar,
        ...
        initNode(nodeId, node, nodeStyleClass, usesKeyHandler, focusTraversable, enabled);
    }
    ...
    public TextField buildTextField(Object nodeId,
        ...
        // INITIALIZE THE OTHER SETTINGS
        initNode(nodeId, textField, parent, col, row, colSpan, rowSpan, styleClass, usesKeyHandler, focusTraversable, enabled);
    ...
    public TableView buildTableView(Object nodeId,
        ...
        // INITIALIZE THE OTHER SETTINGS
        initNode(nodeId, tableView, parent, col, row, colSpan, rowSpan, styleClass, usesKeyHandler, focusTraversable, enabled);
