...
public class AppGUIModule {
    ...
    public void loadGUI(Stage initPrimaryStage) throws LanguageException {
        ...
        // WITHOUT THE TOP TOOLBAR
            ...
            props.addProperty(HAS_HOME_TOOLBAR, FALSE);
        }
...
//        if (props.isTrue(HAS_HOME_TOOLBAR)) {
//            initHomeToolbar();
//        }
    ...
    private void initHomeToolbar(){
        ...
        topToolbarPane.getChildren().add(homeToolbar);
       // helpController = new AppHelpController(app);
        ...
        if (props.isTrue(HAS_SNAP)) {
            ToggleButton snapButton = nodesBuilder.buildIconToggleButton(SNAP_BUTTON, null, homeToolbar, CLASS_DJF_ICON_BUTTON, HAS_KEY_HANDLER, FOCUS_TRAVERSABLE, ENABLED);
            /*aboutButton.setOnAction(e -> {
                helpController.processAboutRequest();
            });*/
        }
